...
function page() {
  return (
    <div className='flex rounded-md justify-center items-center w-full h-full bg-slate-950 border border-slate-700 text-5xl'>
      <h1 className='animate-pulse text-6xl text-slate-300'>Modulo en desarrollo...</h1>
      <i className="fa-solid fa-rocket text-slate-300 animate-spin"></i>
    </div>
  )
}
...
//   const { getProductoByStantre, getProducts, loading, errors } = useProductos();
